...
for i in range (100):
    ...
    if (numero_testado < 10001) and (numero_testado > -10001):
        ...
        if teste_resposta_resultado == resultado_esperado and (str(teste_resposta_api_200) == str(request)):
            ...
            print('##############')
            print('##############')
            retorno = (f'REQUEST DEVERIA SER: {resultado_esperado}, PORÉM RETORNOU: {teste_resposta_resultado}')
            print(retorno)
            print('Testes aprovados:{}'.format(numero_de_testes_aprovados))
            print('Testes reprovados:{}'.format(numero_de_testes_reprovados))
            print()
        ...
        print('##############')
        print('REQUEST DEVERIA SER: {}, PORÉM RETORNOU: {}'.format(teste_resposta_api_400, request))
        retornoAPI = (f'Número testado: {numero_testado}  REQUEST DEVERIA SER: {teste_resposta_api_400}, PORÉM RETORNOU: {request}')
        print('Testes aprovados:{}'.format(numero_de_testes_aprovados))
        print('Testes reprovados:{}'.format(numero_de_testes_reprovados))
        with open("/Users/marcus.pereira/Desktop/qamuch/errosEN-US.txt","a") as file:
                file.write("%s\n" % retornoAPI)
        print()
        print()
        print()
